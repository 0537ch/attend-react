...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted flex items-center justify-center px-4 py-8 sm:px-6 dark:from-gray-900 dark:to-gray-800 relative">
      ...
      <div className="w-full max-w-md">
        ...
        {/* Login Card */}
        <div className="bg-card text-card-foreground rounded-lg shadow-xl p-6 sm:p-8 lg:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 sm:px-3 sm:py-2 text-base border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent bg-background text-foreground min-h-12 sm:min-h-11"
